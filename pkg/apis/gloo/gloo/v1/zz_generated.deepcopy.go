...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CloudmapUpstream) DeepCopyInto(out *CloudmapUpstream) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CloudmapUpstream.
func (in *CloudmapUpstream) DeepCopy() *CloudmapUpstream {
	if in == nil {
		return nil
	}
	out := new(CloudmapUpstream)
	in.DeepCopyInto(out)
	return out
}
